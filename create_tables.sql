...
CREATE INDEX IF NOT EXISTS "IX_Norms_OperationId" ON "Norms" ("OperationId");
CREATE INDEX IF NOT EXISTS "IX_Norms_ProfessionId" ON "Norms" ("ProfessionId");
CREATE INDEX IF NOT EXISTS "IX_Norms_TarifId" ON "Norms" ("TarifId");
CREATE INDEX IF NOT EXISTS "IX_Norms_PartId" ON "Norms" ("PartId");
CREATE INDEX IF NOT EXISTS "IX_Operations_MaterialId" ON "Operations" ("MaterialId");
CREATE INDEX IF NOT EXISTS "IX_Operations_PartId" ON "Operations" ("PartId");
